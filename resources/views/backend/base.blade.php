...
<head>
  ...
  <link rel="icon" type="image/png" href="{{ url('assets/backend/img/icons8-edificio-del-banco-64.png') }}">
  ...
  <link href="{{ url('assets/backend/css/paper-dashboard.css?v=2.0.1') }}" rel="stylesheet" />
...
<body class="">
  ...
  <!-- Chart JS -->
  <script src="{{ url('assets/backend/js/plugins/chartjs.min.js') }}"></script>
  <!--  Notifications Plugin    -->
  <script src="{{ url('assets/backend/js/plugins/bootstrap-notify.js') }}"></script>
  <!-- Control Center for Now Ui Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="{{ url('assets/backend/js/paper-dashboard.min.js?v=2.0.1') }}" type="text/javascript"></script>
  @yield('postscript')
</body>
