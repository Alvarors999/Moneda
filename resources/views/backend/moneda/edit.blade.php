...
<form role="form" action="{{ url('backend/moneda/' . $moneda->id) }}" method="post" id="editMonedaForm" enctype="multipart/form-data">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" maxlength="40" minlength="2" required class="form-control" id="nombre" placeholder="Nombre de la Moneda" name="nombre" value="{{ old('nombre', $moneda->nombre) }}">
        </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" maxlength="20" minlength="5" required class="form-control" id="valor" placeholder="Valor de la Moneda en Euros" name="valor" value="{{ old('valor', $moneda->valor) }}">
    </div>
    <div class="form-group">
