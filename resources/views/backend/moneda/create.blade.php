...
@endif
<form role="form" action="{{ url('backend/moneda') }}" method="post" id="createEnterpriseForm">
    @csrf
    <div class="card-body">
        <div class="form-group">
            <label for="nombre">Nombre</label>
            <input type="text" maxlength="40" minlength="2" required class="form-control" id="nombre" placeholder="Nombre de la Moneda" name="nombre" value="{{ old('nombre') }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" maxlength="40" minlength="2" required class="form-control" id="pais" placeholder="Pais de la Moneda" name="pais" value="{{ old('pais') }}">
        </div>
        <div class="form-group">
